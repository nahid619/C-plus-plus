...
void features::booths() {
	...
	onlyDisplay d;
	gotoxy(65, 3);
	cout << "\xB2\xB2\xB2\xB2  Process of Trafic Control  \xB2\xB2\xB2\xB2\n\n\n";
	char ch;
	ifstream fin;
...
void onlyDisplay::menu() {
	...
	cout << "4. Display information of traffic control system\n";	gotoxy(50, 17);
	...
	//if(sound==0){
		...
		//sound++;
	//}
	Beep(400,500);Beep(400,500);Beep(400,500);Beep(400,500);Beep(400,500);Beep(400,500);Beep(400,500);
